...
const data = {
    data1:{
      ...
      firstName:'James',
      lastName:'James',
      email:'james1@yahoo.com',
      phone:'112234567', 
      callBackphone:'112234567',
      title:'MD',
      groupno:'g-1100', 
      hospital:'City Hospital,John Hockins',
           ...
           <Grid container spacing={0}>
              ...
              <Grid item xs={12} style={{paddingBottom:'3%'}}><Divider/></Grid>
              {
               Object.values(data).map((type,key)=>{
                   if(this.props.match.params.id===type.id){
                       return (
                        <div>
                        <Grid item xs={12} md={12}>
                        <Grid container spacing={16} direction="column" justify="center" alignContent="center" alignItems="center">
                            <Grid item xs={12}>
                            <Avatar alt="Remy Sharp" src={type.image} className={classes.bigAvatar} />
                            </Grid>
                            <Grid item xs={12}>
                      ...
                      <Grid item xs={12} md={12}>
                          <Grid container spacing={8}>
                              ...
                              <Grid item xs={12} sm={12} md={12}>
                                  ...
                                  margin="dense"
                                  variant="outlined"
                                  defaultValue={type.callBackphone}
                                  fullWidth
                                  />
                              </Grid>
                          </Grid>
                      ...
                      <Grid item xs={12} style={{textAlign:'center',paddingTop:'2.5%'}}>
                      <Button variant="contained" color="primary" style={{width:'75%'}}>Edit User</Button>
                      </Grid>  
                      </div>
                       )
                   }

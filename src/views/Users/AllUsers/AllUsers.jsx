...
class SimpleTable extends React.Component {
  ...
  return (
     <Paper className={classes.root}>
      <GridList cols={2} spacing={40} padding= {10}>
      {rows.map((emp, index) => (
            // console.log(emp);
            //<GridListTile>
            ...
            <div className={classes.details}>
              ...
              <div>
                <IconButton aria-label="View Detaials">
                  <View/>
                </IconButton>
